...
public class WaterPokèmon extends Pokèmon {

    private String specialAttack;
    private String weakness;

    public WaterPokèmon(String name, String food, String sound, String type, int hp, int attack, int defense, String specialAttack, String weakness) {
